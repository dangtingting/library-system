...
如果MySQL的root用户密码不是`123456`，请修改配置文件：
...
1. **右键点击** `deploy.bat` 文件
2. 选择 **"以管理员身份运行"**
3. 等待脚本自动完成部署

### 步骤四：启动系统

1. 部署完成后，会生成 `start-library-system.bat`
2. 双击运行该文件启动系统
...
2. 右键点击 → "Run 'LibraryManagementSystemApplication'"
3. 等待项目启动完成
...
如需添加新表或字段：
1. 修改 `src/main/resources/database/init.sql`
2. 在Entity类中添加对应字段
3. 重新部署项目
